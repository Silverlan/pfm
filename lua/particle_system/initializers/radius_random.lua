...
function ents.ParticleSystemComponent.InitializerRadiusRandom:Initialize()
	self.m_radiusMin = tonumber(self:GetKeyValue("radius_min") or "") or 1.0
	self.m_radiusMax = tonumber(self:GetKeyValue("radius_max") or "") or 1.0
	self.m_radiusRandomExponent = tonumber(self:GetKeyValue("radius_random_exponent") or "") or 1.0
end
