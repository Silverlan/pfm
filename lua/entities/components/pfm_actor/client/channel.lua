...
function ents.PFMActorComponent.Channel:SetDefault(controllerId, defaultValue)
	self.m_defaultValues[controllerId] = defaultValue
end
...
function ents.PFMActorComponent.Channel:GetTransforms()
	return self.m_transforms
end
