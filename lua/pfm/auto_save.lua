...
console.register_variable("pfm_autosave_enabled",udm.TYPE_BOOLEAN,true,bit.bor(console.FLAG_BIT_ARCHIVE),"Enables or disables PFM autosaving.")
console.register_variable("pfm_autosave_max_count",udm.TYPE_UINT16,5,bit.bor(console.FLAG_BIT_ARCHIVE),"Maximum number of autosaves before old ones will be overwritten.")
console.register_variable("pfm_autosave_time_interval",udm.TYPE_UINT32,10 *60,bit.bor(console.FLAG_BIT_ARCHIVE),"Time in seconds between autosaves.")
