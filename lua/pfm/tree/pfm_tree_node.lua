...
function pfm.Tree.Node:GetChildren()
	return self.m_children
end
function pfm.Tree.Node:GetName()
	return self.m_name
end
function pfm.Tree.Node:SetName(name)
	self.m_name = name
end

function pfm.Tree.Node:GetAttribute()
	return self.m_udmAttribute
end
function pfm.Tree.Node:SetAttribute(attr)
	self.m_udmAttribute = attr
end
...
function pfm.Tree.Node:AssignUDMItem(name, item)
	...
	if item:IsAttribute() == false or item:IsArray() == false then
		return
	end
