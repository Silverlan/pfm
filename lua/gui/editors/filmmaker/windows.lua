...
pfm.get_registered_windows = function() return g_registeredWindows end
...
pfm.register_window("primary_viewport","viewers",locale.get_text("pfm_primary_viewport"),function(pm)
	...
	el:AddCallback("OnReattached",function(el,window) pm:RequestFocus() end)
	return el
end)
...
pfm.register_window("render","viewers",locale.get_text("pfm_render"),function(pm)
	...
	el:GetVisibilityProperty():AddCallback(function(wasVisible,isVisible)
		if(pm.m_renderWasSceneCameraEnabled == nil) then pm.m_renderWasSceneCameraEnabled = ents.PFMCamera.is_camera_enabled() end
...
pfm.register_window("post_processing","viewers",locale.get_text("pfm_post_processing"),function(pm) return gui.create("WIPFMPostProcessing") end)
pfm.register_window("video_player","viewers",locale.get_text("pfm_video_player"),function(pm) return gui.create("WIPFMVideoPlayer") end)
...
pfm.register_window("timeline","timeline",locale.get_text("pfm_timeline"),function(pm)
	...
	pfmTimeline:AddCallback("OnUserInputStarted",function() userInteractionTimeStart = pm:GetTimeOffset() end)
