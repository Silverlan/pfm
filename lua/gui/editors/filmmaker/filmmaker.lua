...
function gui.WIFilmmaker:GetInputBindingLayer(id)
	return self.m_inputBindingLayers[id or "pfm"]
end
function gui.WIFilmmaker:UpdateInputBindings()
	input.update_effective_input_bindings()
end
...
function gui.WIFilmmaker:IsAutosaveEnabled()
