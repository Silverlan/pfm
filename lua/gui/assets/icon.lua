...
include("/gui/widgets/image_icon.lua")
...
local function create_model_view(width, height, parent)
	local el = gui.create("model_view", parent)
...
gui.register("asset_icon", gui.AssetIcon)
...
gui.register("directory_asset_icon", gui.DirectoryAssetIcon)
...
gui.register("model_asset_icon", gui.ModelAssetIcon)
...
gui.register("material_asset_icon", gui.MaterialAssetIcon)
...
gui.register("texture_asset_icon", gui.TextureAssetIcon)
...
gui.register("particle_asset_icon", gui.ParticleAssetIcon)
