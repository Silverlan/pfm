...
function Element:OnThink()
	if(self.m_worldPos == nil) then return end
	local parent = self:GetParent()
	if(parent:GetClass() ~= "wiviewport") then return end
...
function Element:GetText() return self.m_elTextHover:GetText() end
...
gui.register("WIHoverText",Element)
