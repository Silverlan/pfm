...
include("/gui/layout/grid_box.lua")
include("/gui/wibasefileexplorer.lua")
include("/gui/assets/icon.lua")
include("/gui/layout/icon_grid_view.lua")
...
function gui.AssetExplorer:OnInitialize()
	...
	self:SetIconFactory(function(parent)
		return gui.create("asset_icon", parent)
	end)
...
gui.register("asset_explorer", gui.AssetExplorer)
