...
function gui.PFMMaterialEditor:InitializePreviewControls()
	...
	renderMode:AddOption(locale.get_text("pfm_mated_render_mode_albedo"),tostring(ents.SceneComponent.DEBUG_MODE_ALBEDO))
	renderMode:AddOption(locale.get_text("pfm_mated_render_mode_normals"),tostring(ents.SceneComponent.DEBUG_MODE_NORMAL))
	renderMode:AddOption(locale.get_text("pfm_mated_render_mode_metalness"),tostring(ents.SceneComponent.DEBUG_MODE_METALNESS))
	renderMode:AddOption(locale.get_text("pfm_mated_render_mode_roughness"),tostring(ents.SceneComponent.DEBUG_MODE_ROUGHNESS))
	renderMode:AddOption(locale.get_text("ambient_occlusion"),tostring(ents.SceneComponent.DEBUG_MODE_AMBIENT_OCCLUSION))
	renderMode:AddOption(locale.get_text("pfm_mated_render_mode_diffuse_lighting"),tostring(ents.SceneComponent.DEBUG_MODE_DIFFUSE_LIGHTING))
	renderMode:AddOption(locale.get_text("pfm_mated_render_mode_reflectance"),tostring(ents.SceneComponent.DEBUG_MODE_REFLECTANCE))
	renderMode:AddOption(locale.get_text("pfm_mated_render_mode_emission"),tostring(ents.SceneComponent.DEBUG_MODE_EMISSION))
