...
include("/gui/pfm/widgets/progress_bar.lua")
include("button.lua")
...
function Element:OnInitialize()
	...
	self.m_progressBar = gui.create("pfm_progress_bar", self, 0, self:GetHeight() - 5, self:GetWidth(), 5, 0, 1, 1, 1)
...
gui.register("pfm_tab_button", Element)
