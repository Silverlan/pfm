...
include("/gui/explorers/texture_explorer.lua")
...
function Element:CreateIconExplorer(baseElement)
	return gui.create("texture_explorer", baseElement, 0, 0, self:GetWidth(), self:GetHeight())
end
gui.register("pfm_texture_catalog", Element)
