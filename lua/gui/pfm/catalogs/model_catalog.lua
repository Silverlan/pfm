...
include("/gui/explorers/model_explorer.lua")
...
function Element:CreateIconExplorer(baseElement)
	local explorer = gui.create("model_explorer", baseElement, 0, 0, self:GetWidth(), self:GetHeight())
	explorer:SetName("model_explorer")
	return explorer
end
gui.register("pfm_model_catalog", Element)
