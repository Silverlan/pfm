...
include("core/base/base_filmmaker.lua")
...
include("/gui/timeline/film_strip.lua")
include("/gui/timeline/generic_clip.lua")
include("/gui/witabbedpanel.lua")
include("/gui/editors/wieditorwindow.lua")
include("/gui/overlay/patreon_ticker.lua")
include("/gui/pfm/editors/bone_retargeting.lua")
include("/gui/pfm/editors/ik_rig_editor.lua")
include("/gui/overlay/drag_and_drop_overlay.lua")
include("/gui/pfm/viewport/viewport.lua")
include("/gui/pfm/dialogs/message_prompt.lua")
include("/gui/pfm/viewport/post_processing.lua")
include("/gui/pfm/viewport/video_player.lua")
include("/gui/pfm/timeline/timeline.lua")
include("/gui/pfm/editors/element_viewer.lua")
include("/gui/pfm/editors/actor_editor/actor_editor.lua")
include("/gui/pfm/catalogs")
include("/gui/pfm/viewport/render_preview.lua")
include("/gui/pfm/editors/material_editor/materialeditor.lua")
include("/gui/pfm/editors/particle_editor.lua")
include("/gui/pfm/web_browser.lua")
include("/gui/pfm/editors/code_editor.lua")
include("/gui/pfm/panels/loading_screen.lua")
include("/gui/pfm/panels/settings.lua")
include("/gui/pfm/dialogs/kernels_build_message.lua")
include("core/progress_status_info.lua")
include("/pfm/util/particle_system.lua")
...
include("/pfm/util/video_recorder.lua")
include("/pfm/core/selection_manager.lua")
include("/pfm/util/animation_recorder.lua")
include("core/update.lua")
include("core/windows.lua")
include("core/tutorials.lua")
...
function gui.WIFilmmaker:OnInitialize()
	...
	local playbackControls = gui.create("playback_controls",framePlaybackControls)
...
function gui.WIFilmmaker:OnFileDragEntered()
	...
	self.m_dragOverlay = gui.create("drag_and_drop_overlay", self, 0, 0, self:GetWidth(), self:GetHeight(), 0, 0, 1, 1)
...
gui.register("filmmaker", gui.WIFilmmaker)
