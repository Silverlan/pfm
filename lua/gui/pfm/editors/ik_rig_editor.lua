...
function Element:OnInitialize()
	...
	local controls =
		gui.create("pfm_controls_menu", scrollContainer, 0, 0, scrollContainer:GetWidth(), scrollContainer:GetHeight())
...
gui.register("ik_rig_editor", Element)
