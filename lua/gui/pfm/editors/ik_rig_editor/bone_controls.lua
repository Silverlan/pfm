...
function Element:AddControl(item, boneName, controlType)
	...
	local ctrl = gui.create("pfm_controls_menu", ctrlsParent, 0, 0, ctrlsParent:GetWidth(), ctrlsParent:GetHeight())
...
function Element:InitializeBoneControls(mdl)
	...
	local tree = gui.create("pfm_tree_view", subMenu, 0, 0, subMenu:GetWidth(), 20)
