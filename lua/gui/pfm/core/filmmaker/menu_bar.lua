...
function Element:InitializeMenuBar()
	...
	self:AddWindowsMenuBarItem(function(pContext)
		...
		local pItem, pSubMenu = pContext:AddSubMenu(gui.Loc("pfm_font_size"))
		pItem:SetName("font_size")
		pSubMenu:SetName("font_size_menu")
		pSubMenu:AddItem(gui.Loc("pfm_decrease_font_size"), function(pItem) pfm.decrease_font_size() end)
		pSubMenu:AddItem(gui.Loc("pfm_increase_font_size"), function(pItem) pfm.increase_font_size() end)
		pSubMenu:AddItem(gui.Loc("pfm_reset_font_size"), function(pItem) pfm.reset_font_size() end)
		pItem:SetTooltip(gui.Loc("font_size_menu_font"))
		pSubMenu:ScheduleUpdate()
